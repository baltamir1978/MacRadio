...
private nonisolated let lyricsLog = Logger(subsystem: "com.macradio.playback", category: "lyrics")
...
nonisolated enum LyricsService {
    ...
    private static func search(track: String, artist: String?) async -> Outcome {
        ...
        request.setValue("MacRadio/1.0 (https://github.com/baltamir1978/MacRadio)", forHTTPHeaderField: "User-Agent")
